...
const BestSeller = () => {
  ...
  // Toggle between showing 5 products and all products
  const productsToShow = showAll ? allproductData : allproductData.slice(0, 5);
      ...
      <div className="w-10/12 mx-auto">
        <div className="flex flex-col items-center justify-between pt-10 pb-10 xs:flex-row">
          ...
          <Link
            ...
            onClick={() => setShowAll(!showAll)} // Toggle view on click
          >
